...
begin
	using Makie: Makie
	using AlgebraOfGraphics: Layer, Entry, LinesFill
...
begin
	...
	function (qb::QuantileBand)(e::Entry)
		entry = map(e) do p, n
			x, y = p
	...
	quantileband(; kwargs...) = Layer((QuantileBand(Dict{Symbol,Any}(kwargs)),))
end
...
begin
	...
	function (bs::BinScatter)(e::Entry)
		entry = map(e) do p, n
			x, y = p
			weights = get(n, :weights, nothing)
	...
	binscatter(; kwargs...) = Layer((BinScatter(Dict{Symbol,Any}(kwargs)),))
end
