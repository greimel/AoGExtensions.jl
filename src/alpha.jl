...
# ╔═╡ fd9a3552-f074-11ec-009a-a5a5ca993571
using CairoMakie, AlgebraOfGraphics

# ╔═╡ 223b74eb-9a73-452c-8c4f-fb568959cc8a
using DataFrames, DataFrameMacros, Chain

# ╔═╡ aff9634a-f27f-4e42-b248-f6b5275535c3
# mostly compute_attributes
using AlgebraOfGraphics: ProcessedLayer, MixedArguments, NamedArguments, valid_options, automatic, Dictionary, filterkeys, FigureGrid

# ╔═╡ fb74a7fc-bda6-4f91-bc59-5c78b0f4cde5
using AlgebraOfGraphics: update, compute_axes_grid, compute_palettes, categoricalscales

# ╔═╡ 39dfe9f8-a723-4ba7-823c-bd4e91eeba55
# categorical scales
using AlgebraOfGraphics: iscategoricalcontainer, CategoricalScale, uniquevalues, to_label

# ╔═╡ 1c1ba57e-94e6-49be-b415-c779de8213d8
df = let
	n = 100
	DataFrame(x = rand(n), y = rand(n), grp = rand(["a", "b", "c"], n))
end


# ╔═╡ b6ce1a30-23b9-479a-bc04-5fff69972f98
palettes = (;)#(; alpha = [0.1, 0.5, 0.9])

# ╔═╡ bb478688-5e8b-4431-b4b1-689ef87be613
function AlgebraOfGraphics.categoricalscales(processedlayer::ProcessedLayer, palettes)
...
# ╔═╡ 440da989-7e89-4fac-b7eb-9b823e19fa74
function AlgebraOfGraphics.legend_elements(::Type{Scatter};
...
# ╔═╡ 2e6fbfcb-4472-4a62-95a4-6e3731877063
@chain df begin
	data(_) * mapping(:x, :y, alpha = :grp) * visual(Scatter)
	@aside f = Figure()
	#ProcessedLayer
	#@aside pal = compute_palettes(palettes)
	#categoricalscales(pal)
	#_[:alpha]
	#update(f -> compute_axes_grid(f, _; axis=(;), palettes=(;)), fig)
    #foreach(plot!, _)
	#plot!(f, _; palettes)#; axis, palettes)
	#FigureGrid(f, _)
    #facet!(_; facet=(;))
	#@aside f
	draw
...
# ╔═╡ d58ea520-c3d8-478d-a2a4-37a62162699a
function AlgebraOfGraphics.compute_attributes(pl::ProcessedLayer,
...
manifest_format = "2.0"
project_hash = "92be6853d297292ffa9d7269be86c9c1cc16a861"
